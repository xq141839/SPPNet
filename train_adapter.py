...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,default='datasets/', help='the path of images')
    parser.add_argument('--prompt', type=str,default='pre_weights/sam_vit_b_01ec64.pth', help='')
    parser.add_argument('--encoder', type=str,default='pre_weights/sam_vit_b_01ec64.pth', help='')
    parser.add_argument('--jsonfile', type=str,default='datasets/monuseg/data_split.json', help='')
    ...
    # model_ft.load_state_dict(torch.load(args.encoder), strict=False)

    # pretrain_dict = torch.load(args.encoder)
    # model_dict = model_ft.state_dict()
    # image_encoder_dict = {k: v for k, v in pretrain_dict.items() if k in model_dict}
    # print(image_encoder_dict.keys())
    # model_dict.update(image_encoder_dict)
    # model_ft.load_state_dict(model_dict, strict=True)
